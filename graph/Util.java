...
//	}
	...
	public static HashMap<Integer, HashSet<Integer>> copyMap(HashMap<Integer, HashSet<Integer>> hashMap) {
		HashMap<Integer, HashSet<Integer>> copyMap = new HashMap<Integer, HashSet<Integer>>();
		for (Map.Entry<Integer, HashSet<Integer>> entry : hashMap.entrySet()) {
			HashSet<Integer> copySet=new HashSet<Integer>();
			for (Integer integer : entry.getValue()) {
				copySet.add(integer);
			}
			copyMap.put(entry.getKey(),copySet);
		}
		return copyMap;
	}
